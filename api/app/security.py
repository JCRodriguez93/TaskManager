...
SECRET_KEY = os.environ.get('JWT_SECRET_KEY') or 'CAMBIAR-EN-PRODUCCIONusar-secrets.token_hex-32'
...
def crear_access_token(
    ...
    expira = datetime.utcnow() + (
        expires_delta or timedelta(minutes=ACCESS_EXPIRE)
    )
...
# ── OAuth2 y verificación de tokens ──────────────────────────────────

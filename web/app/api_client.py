...
# web/app/api_client.py — añadir al final

def manejar_api_error(ruta_fallback: str = 'main.index'):
    """
    Decorador para rutas Flask que llaman a la API.
    Si la API falla, muestra un flash de error y redirige a ruta_fallback.
    ...
    def decorador(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                return redirect(url_for(ruta_fallback))
        return wrapper
    return decorador
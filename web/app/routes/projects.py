...
# Lista en memoria (en U04 la sustituiremos por la base de datos)
# RECUERDA ELIMINAR LA LISTA PROYECTOS_PRUEBA
PROYECTOS = [
    {
        'id': 1,
...
def nuevo():
    ...
    if form.validate_on_submit():
        ...
        flash(f'Proyecto "{nuevo_proyecto["titulo"]}" creado correctamente.', 'success')

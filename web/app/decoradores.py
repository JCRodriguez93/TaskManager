# web/app/decoradores.py — nuevo archivo
...
def propietario_o_admin(obtener_recurso):
    ...
    def decorador(f):
        ...
        def decorated(*args, **kwargs):
            ...
            recurso = obtener_recurso(kwargs)

...
with app.app_context():
    ...
    tareas_p1 = [
        ...
        Tarea(
            titulo='Optimizar imágenes para web',
            prioridad='media',
            estado='pendiente',
            proyecto_id=p1.id
        ),
        ...
        Tarea(
            titulo='Corregir bug en el formulario de contacto',
            prioridad='urgente',
            estado='pendiente',
            proyecto_id=p1.id,
            asignado_id=pablo.id
    ...
    tareas_p2 = [
        Tarea(
            titulo='Configurar repositorio y CI/CD',
            prioridad='alta',
            estado='completada',
            proyecto_id=p2.id
        ),
        Tarea(
            titulo='Diseñar arquitectura de la app',
            prioridad='urgente',
            estado='en_progreso',
            proyecto_id=p2.id,
            asignado_id=ana.id
